<?php
$con=mysqli_connect("localhost","root","","mswipe_mqr");
// Check connection
...
$sql="SELECT COUNT(`Appl_No`) as ApplCount FROM `mqr_f2a2`";
$sql2="SELECT count(`Appl_Status`) as ApprovedCount from mqr_f2a2_status where Appl_Status='Approved';";
...
<html lang="en">
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown1" aria-expanded="false" style="color:green !important;">
  ...
  while($row = $result->fetch_assoc()) {
        echo "Last update: ".$row["CreatedOn"];
    }
} else {
    echo "0 results";
}
  ...
  mysqli_free_result($result);
                ...
                <li role="presentation" class="dropdown">
                  <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown1" aria-expanded="false">
                    <!--<i class="fa fa-envelope-o"></i>
                    <span class="badge bg-green">6</span>
					<span class="time">Last update: 23-08-2019</span>-->
                  </a>
  ...
  // Fetch one and one row
  while($row = $result->fetch_assoc()) {
        echo "<div class='count'>".$row["ApplCount"]."</div>";
    }
} else {
    echo "0 results";
}
  ...
  mysqli_free_result($result);
                  ...
                  <p>Merchants signed up till date</p>
                </div>
              </div>
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
  ...
  // Fetch one and one row
  while($row = $result->fetch_assoc()) {
        echo "<div class='count'>".$row["ApprovedCount"]."</div>";
    }
} else {
    echo "0 results";
}
  ...
  mysqli_free_result($result);
				  ...
				  <h3>Approved + STP</h3>
                  <p>Merchants onboarded & approved till date</p>
                </div>
              </div>
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
  ...
  // Fetch one and one row
  while($row = $result->fetch_assoc()) {
        echo "<div class='count'>".$row["InstalledCount"]."</div>";
    }
} else {
    echo "0 results";
}
  ...
  mysqli_free_result($result);
                  ...
                  <p>Total Number of Activated VPAs</p>
                </div>
              </div>
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
  ...
  // Fetch one and one row
  while($row = $result->fetch_assoc()) {
        echo "<div class='count'>".$row["PendingInstallationCount"]."</div>";
    }
} else {
    echo "0 results";
}
  ...
  mysqli_free_result($result);
			...
			<div class="row top_tiles" style="margin: 10px 0;">
              <div class="col-md-3 col-sm-3 col-xs-6 tile">
                <span style="color:red;">Total Pending</span>
				<?php
				  if ($result=mysqli_query($con,$sql6))
  {
  // Fetch one and one row
  while($row = $result->fetch_assoc()) {
        echo "<h2>".$row["TotalPendingERP"]."</h2>";
    }
} else {
    echo "0 results";
}
  ...
  mysqli_free_result($result);
              ...
              <div class="col-md-3 col-sm-3 col-xs-6 tile">
                <span style="color:red;">Pending for Salesman</span>
                <?php
				  if ($result=mysqli_query($con,$sql7))
  {
  // Fetch one and one row
  while($row = $result->fetch_assoc()) {
        echo "<h2>".$row["TotalPenSalesman"]."</h2>";
    }
} else {
    echo "0 results";
}
  ...
  mysqli_free_result($result);
              ...
              <div class="col-md-3 col-sm-3 col-xs-6 tile">
                <span style="color:red;">Pending for Bank Details</span>
                <?php
				  if ($result=mysqli_query($con,$sql8))
  {
  // Fetch one and one row
  while($row = $result->fetch_assoc()) {
        echo "<h2>".$row["TotalPendingERPBank"]."</h2>";
    }
} else {
    echo "0 results";
}
  ...
  mysqli_free_result($result);
			  ...
			  <div class="col-md-3 col-sm-3 col-xs-6 tile">
                <span style="color:red;">Pending for (Rwrk+Mkr+Chkr+Rsk)</span>
                <?php
				  if ($result=mysqli_query($con,$sql9))
  {
  // Fetch one and one row
  while($row = $result->fetch_assoc()) {
        echo "<h2>".$row["TotalPendingERPMkr"]."</h2>";
    }
} else {
    echo "0 results";
}
  ...
  mysqli_free_result($result);
			...
			<!-- END Pending Data Tiles -->

            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Merchant Onboarding Summary <small>Weekly progress</small></h2>
                    <div class="filter">
